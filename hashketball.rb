...
def team_colors(team_name)
  game_hash.each do |team, stats|
    if stats[:team_name].include?(team_name)
      return stats[:colors]
    end
  end
end
...
def player_numbers(team_name)
  game_hash.each do |location, team|
    if team[:team_name].include?(team_name)
      return team[:players].collect do |names, numbers|
        numbers[:number]
      end
    end
  end
...
def player_stats(players_name)
  game_hash.each do |location, info|
    if info[:players].include?(players_name)
      return info[:players][players_name]
    end
  end
end
